...
<section class="section-exe">
    ...
    <div class="row">
        ...
        <div class="col span-1-of-2 box">
            <ul class="form-nav">
                <form action="AdminAddPremium" method="get" id="formLogin">
                    <label>Username:<input type="text" id="lLoing" name="alogin"/></label>
                    <input type="submit" name="setPrem" value="SET PREMIUM" class="btn log-btn">
                </form>
            </ul>
        </div>
        <div class="col span-1-of-2 box">
